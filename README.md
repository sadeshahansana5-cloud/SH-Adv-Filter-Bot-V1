...
ඉහළ දකුණු කෙළවරේ ඇති **Fork** බොත්තම ඔබා මෙම ව්‍යාපෘතිය ඔබේ GitHub ගිණුමට පිටපත් කරගන්න.
...
## 🛡️ ආරක්ෂාව පිළිබඳ උපදෙස් (Security Tips)

ඔබ මෙම Repository එක **Public** ලෙස පවත්වාගෙන යන්නේ නම්, ඔබේ **Bot Token** එක Code එකේ කෙලින්ම ලියා තැබීම අනාරක්ෂිතයි. ඒ වෙනුවට පහත ක්‍රමය අනුගමනය කරන්න:

* **GitHub Secrets භාවිතා කරන්න:** Settings > Secrets and variables > Actions වෙත ගොස් ඔබේ Token එක `BOT_TOKEN` ලෙස එහි ඇතුළත් කරන්න. ඉන්පසු Code එකේ `os.getenv('BOT_TOKEN')` ලෙස එය භාවිතා කරන්න.
